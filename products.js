...
,
    ...
    description:
      "Call of Duty: Black Ops 6 هي لعبة تصويب من منظور الشخص الأول تقدم حملة سينمائية مشوقة، وطور لعب جماعي سريع، بالإضافة إلى طور الزومبي الشهير، مع أسلحة حديثة وأسلوب لعب مليء بالإثارة.",
    descriptionEn:
      "Call of Duty: Black Ops 6 is a first-person shooter game that offers an exciting cinematic campaign, fast-paced multiplayer mode, and the popular zombies mode, with modern weapons and thrilling gameplay."
  },
...
,
    ...
    description:
      "Dying Light 2 هي لعبة أكشن ورعب بعالم مفتوح تدور أحداثها بعد انتشار وباء عالمي. استخدم مهارات الباركور، والقتال، واتخذ قرارات تؤثر على القصة أثناء استكشاف مدينة مليئة بالمصابين والفصائل المتنافسة.",
    descriptionEn:
      "Dying Light 2 is an action-horror open-world game set after a global pandemic. Use parkour skills, fight, and make choices that affect the story while exploring a city full of infected people and competing factions."
  },
